            ...
            <div className="container mx-auto px-container max-w-6xl relative z-10">
                ...
                <div className="relative">
                    ...
                    <motion.div
                        ...
                        className="absolute left-6 md:left-1/2 top-0 bottom-0 w-[2px] bg-linear-to-b from-primary to-transparent shadow-[0_0_10px_rgba(var(--primary),0.5)] -translate-x-1/2 z-10"
                    ></motion.div>
...
const TimelineNode = ({ item, isEven }: { item: RoadmapItem; isEven: boolean }) => {
    return (
        <div className={cn("relative flex items-center justify-between w-full", isEven ? "flex-row" : "flex-row-reverse")}>
            <div className="w-[calc(50%-3rem)] hidden md:block"></div>
